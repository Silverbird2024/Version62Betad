...
$scope.PushButton173_click = function() {$App.short = $App.M005x001a;};
...
$App.short = $App.M006x001a;};
$scope.Headline259_click = function() {if ($App.redf == "High") {
$App.redf = "Low";
} else {
$App.redf = "High";
};
localStorage.setItem("redf",$App.redf);
$App.redf = localStorage.getItem("redf");};
$scope.PushButton9_click = function() {$App.short = $App.M004x001a;};
$scope.PushButton36_click = function() {$App.short = $App.M007x001a;};
$scope.PushButton123_click = function() {$App.short = $App.M006x001a;};
$scope.PushButton140_click = function() {$scope.GotoPage( "SelectionM014" );};
$scope.Headline257_click = function() {if ($App.redd == "High") {
$App.redd = "Low";
} else {
$App.redd = "High";
};
localStorage.setItem("redd",$App.redd);
$App.redd = localStorage.getItem("redd");};
$scope.Headline258_click = function() {if ($App.rede == "High") {
$App.rede = "Low";
} else {
$App.rede = "High";
};
localStorage.setItem("rede",$App.rede);
$App.rede = localStorage.getItem("rede");};
$scope.Headline260_click = function() {if ($App.redg == "High") {
$App.redg = "Low";
} else {
$App.redg = "High";
};
localStorage.setItem("redg",$App.redg);
$App.redg = localStorage.getItem("redg");};
$scope.Headline256_click = function() {if ($App.redc == "High") {
$App.redc = "Low";
} else {
$App.redc = "High";
};
localStorage.setItem("redc",$App.redc);
$App.redc = localStorage.getItem("redc");};
$scope.Headline254_click = function() {if ($App.reda == "High") {
$App.reda = "Low";
} else {
$App.reda = "High";
};
localStorage.setItem("reda",$App.reda);
$App.reda = localStorage.getItem("reda");};
$scope.Headline255_click = function() {if ($App.redb == "High") {
$App.redb = "Low";
} else {
$App.redb = "High";
};
localStorage.setItem("redb",$App.redb);
$App.redb = localStorage.getItem("redb");};
$scope.Headline261_click = function() {if ($App.redh == "High") {
$App.redh = "Low";
} else {
$App.redh = "High";
};
localStorage.setItem("redh",$App.redh);
$App.redh = localStorage.getItem("redh");};
});
